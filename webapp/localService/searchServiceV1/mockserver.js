sap.ui.define([
	...
	var oMockServer,
		...
		_sJsonFilesModulePath = _sAppModulePath + "localService/searchServiceV1/mockdata";
	...
	return {
		...
		init: function () {
			...
			var oMainDataSource = oDataSource.searchServiceV1;
			...
			if (oUriParameters.get("searchService_errorType")) {
				...
				sEntity = "Fs_C_Bps_Accthldr_Search_V1";
				...
				new MockServer({
					...
					requests: [{
						...
						response: function (oXhr) {
							...
							oAnnotations.error = function () {};
							oAnnotations.success = function () {};
